let g = document.getElementById('khodamForm').addEventListener('submit', function(event) {
...
const khodams = [
    ...
    {name: 'Khodam Macan oren', image: 'assets/macan.jpeg'},
    ...
    {name: 'Khodam Dewa Zeus gacor', image: 'assets/zeus.jpeg'}
];
